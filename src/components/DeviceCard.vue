<template>
  <div class="deviceCard" id="deviceCard">
    ...
    <div class="tabs_2">
      <input class="input_tabs" id="tab1" type="radio" name="tabs_2" checked />
      <label class="label_tabs" for="tab1" title>Карточка</label>
      <input class="input_tabs" id="tab2" type="radio" name="tabs_2" />
      <label class="label_tabs label_span" for="tab2" title>
        События
        <span>3</span>
      </label>
      <section id="content-tab1">
        <div class="card">
          <div class="form_card">
            <label for>ID</label>
            <input type="text" value="53118865" disabled />
            <label for>Владелец</label>
            <select name id disabled>
              <option value>GoodWAN</option>
              <option value>GoodWAN 2</option>
              <option value>GoodWAN 3</option>
            </select>
            <label for>Профиль</label>
            <a class="choice" title="Выбор условия">
              Кнопка
              <svg
                width="24"
                height="24"
            ...
            <form action id="chek">
              <input type="checkbox" id="checkbox-id" checked disabled />
              <label for="checkbox-id">Перемещаемое</label>
            </form>
            ...
            <input type="text" value="Ожидание инициализации" style="color: #FF132F" disabled />
            <form action id="chek">
              <input type="checkbox" id="checkbox-id" disabled />
              <label for="checkbox-id">Отладка</label>
            </form>
            <div class="line"></div>
            <label for>Описание</label>
            <textarea name id disabled>Датчики температуры нужны для того, чтобы проконтролировать температуру в помещении, жидкости, твердого объекта.</textarea>
            <div class="line"></div>
            <label for>Параметр</label>
            <div class="param">
              <input type="text" value="Длина 100" disabled />
              <input type="text" value="Поправка -192.3" disabled />
            </div>
          </div>
        ...
        <div class="table_event">
          ...
          <div class="block_table">
            <table>
              ...
              <tbody>
                <tr>
                  <td class="device">83728480, 90902009, 83728480, 90902009</td>
                  <td>5075</td>
                  <td>Москва</td>
                  <td>28/5/2018</td>
                  <td>09:10:11</td>
